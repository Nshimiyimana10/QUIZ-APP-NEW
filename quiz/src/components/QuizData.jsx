...
function QuizData() {
  ...
  return (
    <div className="container h-screen flex flex-col ml-32 ">
      ...
      <div className="text-center py-4 header-bg shadow-md text-lg font-semibold text-indigo-500 bg-purple-300 rounded-md">
        <h2 className="text-blue-500 text-2xl font-semibold">Who Wants To Be A Eligible For A Job </h2>
      </div>
      {currentQuestion !== 10 ? (
        <>
          <div
            id="game-container"
            className="items-center justify-center my-auto bg-yellow-100"
          >
          ...
          <div className="container text-center header-bg p-2 text-white mt-auto bg-sky-300">
            <h2 className="text-2xl pb-1 border-b border-gray-500 text-blue-600">
              Results: {playerScore}/10
            </h2>
